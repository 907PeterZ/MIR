...
def parse_arguments():
    ...
    parser.add_argument('--raw_video_path', type=str, default='./inference_data/raw_video', help="The directory of the raw video path.")
    parser.add_argument('--audio_data_path', type=str, default='./inference_data/audio_data', help="The directory of the audio data path.")
...
class AudioFeature:
    ...
    def __init__(self, args):
        ...
        model_path = "./cache/wav_model/wav2vec2-base-960h"
